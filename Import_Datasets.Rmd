...
# rownames(data_bo)   <- apply(as.matrix(rownames(data_bo)), 1, 
#                              function(x) str_split(x, "_R1_val_1.fq.gz_STARAligned.out.bam")[[1]][1])
# rownames(data_bo)   <- apply(as.matrix(rownames(data_bo)), 1, 
#                              function(x) str_split(x, "_combined")[[1]][1])
dim(data_bo)
...
# rownames(labels_bo)    <- apply(as.matrix(rownames(labels_bo)), 1, 
#                                 function(x) str_split(x, "_R1_val_1.fq.gz_STARAligned.out.bam")[[1]][1])
# rownames(labels_bo)    <- apply(as.matrix(rownames(labels_bo)), 1, 
#                                 function(x) str_split(x, "_combined")[[1]][1])
