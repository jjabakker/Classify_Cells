...
At the start of the cyle delete 'combined_plot_data' if it exists
...
for (row in 1:nrow(to_review)) {
  ...
  ret             <- read_singlemodel_and_data(rdata_path, model_name, dataset_name, preproc_method)
...
ro1 <- select(ro1, "Xin", "Muraro", "Baron_Mouse", "Baron_Human", "SegerStolpe", "Zhou", "Bo", "Petropoulos1")
knitr::kable(ro1, digits = 2, caption = preproc_method)
